...
class CEBRA(TransformerMixin, BaseEstimator):
    ...
    def __init__(
        ...
        jacobian_weight: float = 0.0,  # 0.0 = Jacobian regularizer off
        adv_aggregate: bool = False,  # True = expose model to every PGD step (0..adv_steps)
    ):
    ...
    def _prepare_fit(
        ...
        *y,
        ...
        solver = cebra.solver.init(
            ...
            adv_aggregate=self.adv_aggregate,
        )
